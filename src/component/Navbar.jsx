    ...
    return (
        <>
            <div className='relative shadow-md shadow-gray-500 bg-slate-700 w-full h-10 flex text-white items-center justify-between py-8 '>
                ...
                <div className='' >
                    <h1 className='drop-shadow-2xl tracking-wider xl:text-3xl lg:text-3xl md:text-text-2xl sm:text-3xl text-2xl ml-[80px] italic '>
                        DP-Jewellery
                    </h1>
                </div>
                <div className='xl:text-3xl lg:text-3xl md:text-text-2xl  flex xl:mr-10 lg:mr-10 md:mr-10 sm:mr-6 mr-5'>
